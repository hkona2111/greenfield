# Changelog
## v0.1.0
* [\#141](https://github.com/bnb-chain/greenfield/pull/141) fix: fix wrong comments of events in storage module
...
* [\#156](https://github.com/bnb-chain/greenfield/pull/156) fix: patch v0.0.11 fix to main branch
