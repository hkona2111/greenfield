...
type Approval struct {
	...
	Extends *types.Any `protobuf:"bytes,3,opt,name=extends,proto3" json:"extends,omitempty"`
}
...
func (m *Approval) GetExtends() *types.Any {
	if m != nil {
		return m.Extends
	}
	return nil
...
var fileDescriptor_fe7c4fc8fb6d4918 = []byte{
	...
	,
}
...
func (m *Approval) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Extends != nil {
		{
			size, err := m.Extends.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
